[![Build Status](https://dev.azure.com/cipriangologan/LearnAzureDevOps/_apis/build/status/ciprianglg.pipelines-python?branchName=master)](https://dev.azure.com/cipriangologan/LearnAzureDevOps/_build/latest?definitionId=8&branchName=master)
